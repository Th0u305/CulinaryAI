             ...
             {loading && ( <SavedRecipes savedRecipe={savedRecipes}/>)}
              <Card className="flex flex-col items-center justify-center h-full min-h-[300px] border-dashed">
                <CardContent className="py-8 flex flex-col items-center text-center">
                  ...
                  <Button
                    className="button-color bg-[#ff9e42] hover:bg-[#ff9e42]"
                    size="sm"
                  >
                    Create Recipe
                  </Button>
          ...
          <TabsContent value="preferences" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Customize your recipe recommendations based on your dietary
                  needs
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center justify-between space-x-2">
                    <Label htmlFor="vegetarian" className="flex-grow">
                      Vegetarian
                    </Label>
                    <Switch id="vegetarian" />
                  </div>
                  <div className="flex items-center justify-between space-x-2">
                    <Label htmlFor="vegan" className="flex-grow">
                      Vegan
                    </Label>
                    <Switch id="vegan" />
                  </div>
                  <div className="flex items-center justify-between space-x-2">
                    <Label htmlFor="gluten-free" className="flex-grow">
                      Gluten-Free
                    </Label>
                    <Switch id="gluten-free" />
                  </div>
                  <div className="flex items-center justify-between space-x-2">
                    <Label htmlFor="dairy-free" className="flex-grow">
                      Dairy-Free
                    </Label>
                    <Switch id="dairy-free" />
                  </div>
                  <div className="flex items-center justify-between space-x-2">
                    <Label htmlFor="nut-free" className="flex-grow">
                      Nut-Free
                    </Label>
                    <Switch id="nut-free" />
                  </div>
                  <div className="flex items-center justify-between space-x-2">
                    <Label htmlFor="low-carb" className="flex-grow">
                      Low-Carb
                    </Label>
                    <Switch id="low-carb" />
                  </div>
                ...
                <Button className="mt-4  bg-[#ff9e42] hover:bg-[#ff9e42] button-color">
                  Save Preferences
                </Button>
              </CardContent>
            </Card>
                ...
                <div className="flex items-center justify-between space-x-2">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Receive weekly recipe suggestions based on your
                      preferences
                    </p>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex flex-col items-center sm:flex-row sm:items-start gap-6 mb-6">
                  ...
                  <div className="space-y-2 flex-grow">
                    ...
                    <Input
                      id="profile-name"
                      defaultValue={userData?.given_name || "User"}
                    />

                    <Label htmlFor="profile-email" className="mt-4">
                      Email
                    </Label>
                    <Input
                      id="profile-email"
                    ...
                    <div className="pt-4">
                      <Button className=" bg-[#ff9e42] hover:bg-[#ff9e42] button-color">
                        Save Changes
                      </Button>
                    </div>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <Button
                    variant="outline"
                    className="w-full sm:w-auto button-color"
                  >
                    Change Password
                  </Button>
                </div>
                ...
                <div>
                  <Button className="button-color" variant="destructive">
                    Delete Account
                  </Button>
